...
//			pstmt = conn.prepareStatement(sql);
			...
			while (rs.absolute(index)) {
				...
				board.setMessenger(rs.getString("messenger"));
				list.add(board);
...
//			pstmt.setInt(1, board.getNum());
			...
			pstmt.setString(index++, board.getMessenger());
	...
	public void updateBoard(BoardDTO board) {
		...
		try {
			String sql = "update board set name=?, subject=?, content=?, messenger=? where num=?";
			...
			pstmt.setString(5, board.getMessenger());
